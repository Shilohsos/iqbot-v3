...
INSERT OR IGNORE INTO templates (key, category, state, message, auto_delete, delay_sec) VALUES ('experienced_need_new', 'onboarding_entry', 'experienced_need_new_sent', 'Say less. 2 minutes and you''re in.\n\n👇 Create your free account here:\nhttps://iqbroker.com/lp/regframe-01-light-nosocials/?aff=749367&aff_model=revenue\n\nUse your real email. Once done, drop your User ID below.', 0, 0);
...
INSERT OR IGNORE INTO templates (key, category, state, message, auto_delete, delay_sec) VALUES ('verify_fail_2', 'onboarding_entry', 'awaiting_user_id', '❌ Still no luck @username.\n\nLet''s get you a fresh account the right way.\n\n👇 Create one here:\nhttps://iqbroker.com/lp/regframe-01-light-nosocials/?aff=749367&aff_model=revenue\n\nCome back and drop your new User ID once done.', 0, 0);
