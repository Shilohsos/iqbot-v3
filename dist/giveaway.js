import { dbCreateGiveawayEvent, getGiveawayEvent, getGiveawayEvents, getActiveGiveaways, setGiveawayStatus, incrementGiveawayWinnerCount, getUser, getApprovedUsersWithTier, getGiveawayParticipant, insertGiveawayParticipant, getGiveawayParticipants, getGiveawayParticipantCount, incrementParticipantTradeCount, setParticipantWinner, getActiveParticipations, insertGiveawayUpdate, getPendingGiveawayUpdates, markGiveawayUpdateSent, getRandomMotivationalMessage, insertNotification, getPendingNotifications, markNotificationSent, markNotificationFailed, } from './db.js';
...
export async function participate(giveawayId, telegramId) {
    ...
    queueParticipantUpdate(giveawayId, participantId, telegramId, 'joined', `✅ You're in! *${event.title}*\n\n${count} participants so far. Good luck! 🍀`);
    return {
        success: true,
