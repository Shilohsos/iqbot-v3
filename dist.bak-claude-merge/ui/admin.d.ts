...
interface GiveawayEventLike {
    id: number;
    status: string;
    event_type: string;
}
export declare function giveawayViewKeyboard(event: GiveawayEventLike): IKMarkup;
export declare function getAdminId(): number;
export declare function adminKeyboard(adminAnalysisAll?: boolean): IKMarkup;
export declare function memberFilterKeyboard(): IKMarkup;
export declare function userDetailKeyboard(telegramId: number): IKMarkup;
export declare function mediaLibraryKeyboard(keys: {
    template_key: string;
    media_type: string | null;
    description?: string;
}[]): IKMarkup;
export declare function llmCategoryKeyboard(categories: {
    category: string;
    count: number;
}[]): IKMarkup;
export declare function broadcastPreviewKeyboard(): IKMarkup;
...
export declare function composeToneKeyboard(): IKMarkup;
export declare function composeResultKeyboard(): IKMarkup;
export declare function composeButtonKeyboard(): IKMarkup;
export declare function composeDeliveryKeyboard(): IKMarkup;
export declare function reviewsKeyboard(): IKMarkup;
export declare function reviewResultKeyboard(): IKMarkup;
export {};
