...
const GO_HOME_FALLBACK = { flow: 'go_home', message: '', shouldReply: true };
async function classifyFlow(text, context) {
    if (!DEEPSEEK_API_KEY)
...
export async function getBrainFlow(userId, text, context) {
    if (!checkRateLimit(userId))
        return { flow: 'go_home', message: '', shouldReply: false };
