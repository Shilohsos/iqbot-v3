...
import { getGiveawayEvent, getGiveawayEvents, getActiveGiveaways, getRealAndFabricatedCounts, type GiveawayEventInput, type GiveawayEvent } from './db.js';
...
export declare function setGiveawayReconnect(fn: (telegramId: number) => Promise<string | null>): void;
...
export declare function tickPromoFabrication(): Promise<void>;
